...
import com.estudoAPI.pontointeligente.api.dtos.LancamentoDto;
...
import com.estudoAPI.pontointeligente.api.enums.TipoEnum;
...
public class LancamentoController {
	...
	public ResponseEntity<Response<Page<LancamentoDto>>> listarPorFuncionarioId(
		...
		Page<Lancamento> lancamentos = this.lancamentoService.buscarPorFuncionarioId(funcionarioId, PageRequest.of(pag, qtdPorPagina, Direction.DESC, ord));
